Algoritmo p2_5
	//Diseñar el algoritmo que lea el valor correspondiente a un área en unidades del Sistema
	//anglosajón de unidades y las escriba expresadas en unidades del sistema internacional de unidades.
	Imprimir "Este programa convierte una unidad de área del sistema anglosajon al MKS" 
	...
	msinter[1]='Micrómetros^2'
	msinter[2]='Milímetro^2'
	msinter[3]='Centímetro^2'
	msinter[4]='Metro^2'
	msinter[5]='Kilómetro^2'
