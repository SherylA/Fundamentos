Algoritmo p5_5
	...
	Imprimir "El participante de un concurso tiene que recorrer en su automóvil una ruta determinada desde una ciudad A a una ciudad B"
	Imprimir "Entre las ciudades hay cierto número de gasolineras y al auto tiene un limite de distacia recorrida usando el tanque lleno." 
	Imprimir "Este programa calcula en que gasolineras debe parar para llegar con el menor número de paradas"
	Imprimir  "Ingrese la distancia entre la ciudad A y la ciudad B en [Km]" 
	Leer D
	Si D>=0
		...
		Imprimir "Hay ",i-2," gasolineras entre la ciudad A y la ciudad B y el auto recorre como máximo ",K," [Km]" 
