...
#Mientras t sea menor al tiempo de subida usamos la ecuación de subida
for i in range(0,N):
	t=i*dt
...
#Es decir el tiempo debe ser medido como t-ts
#Pero en el for anterior no hemos pasado el valor de ts ¿cúanto faltaría? t=tw+dt-ts
tw=t
t=tw+dt-ts
